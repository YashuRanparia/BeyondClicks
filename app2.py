...
class MainApp(QMainWindow):
    ...
    def __init__(self):
        ...
        # Add slides (pages) to the stacked widget
        # for slide_number in range(1, 6):
        #     slide = PresentationScreen(slide_number)
    ...
    def createMenubar(self):
        ...
        presentation_menu = menubar.addMenu("Presentation")
        presentation_action = QAction("Start Presentation",self)
        ...
        open_action.triggered.connect(self.find_files)
